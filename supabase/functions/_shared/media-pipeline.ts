// MIRROR of src/lib/media-pipeline.ts for the Deno edge runtime.
// Keep in sync with the app copy; logic is identical and covered by
// scripts/test_media_pipeline.ts.
// ─────────────────────────────────────────────────────────────
