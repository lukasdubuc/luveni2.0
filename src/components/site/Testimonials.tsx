      ...
      <div className="mx-auto max-w-7xl px-6 py-24 md:py-32">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-4 text-4xl tracking-tight md:text-5xl">
            Quietly <span className="serif-italic text-foreground">loved</span> by early customers.
          </h2>
        </div>
        <div className="mt-16 grid gap-6 md:grid-cols-3">
          {items.map((t, index) => (
            <figure
              key={`${t.name}-${index}`}
              className="flex h-full flex-col border border-black/10 p-8 bg-background/50"
