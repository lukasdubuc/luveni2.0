...
// API Keys
export const MISTRAL_API_KEY = import.meta.env.MISTRAL_API_KEY || import.meta.env.VITE_MISTRAL_API_KEY || "";
export const TAVILY_API_KEY  = import.meta.env.TAVILY_API_KEY  || import.meta.env.VITE_TAVILY_API_KEY  || "";
...
- Search Query Optimization: When calling the 'google_search' tool, always keep the query argument extremely concise, direct, and keyword-only (e.g., "US President" or "Shopify setup guide"). Never pass long conversational sentences, questions, or narratives as search queries.
