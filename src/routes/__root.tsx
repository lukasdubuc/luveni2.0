...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/80f9753a-e77f-48e9-ab03-bafefc8a6bcf/id-preview-efaa3fae--4a024234-3250-4065-952b-d4f55051792b.lovable.app-1780502309860.png" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { title: "Luveni" },
      { property: "og:title", content: "Luveni" },
      { name: "twitter:title", content: "Luveni" },
      { name: "description", content: "- Build a conversion-focused e-commerce website with real-time theme switching for online sales and lead capture." },
      { property: "og:description", content: "- Build a conversion-focused e-commerce website with real-time theme switching for online sales and lead capture." },
      { name: "twitter:description", content: "- Build a conversion-focused e-commerce website with real-time theme switching for online sales and lead capture." },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/80f9753a-e77f-48e9-ab03-bafefc8a6bcf/id-preview-efaa3fae--4a024234-3250-4065-952b-d4f55051792b.lovable.app-1780502309860.png" },
