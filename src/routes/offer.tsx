            ...
            <div className="border border-black/10 bg-background/50 p-6">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                    ...
                    href={checkoutHref}
                    className={`inline-flex items-center justify-center border border-black bg-foreground px-6 py-3 text-sm font-semibold text-background transition hover:bg-background hover:text-foreground ${checkoutDisabled ? "pointer-events-none opacity-50" : ""}`}
                  >
