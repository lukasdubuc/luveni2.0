  ...
  return (
    <section className="bg-background">
      <div className="mx-auto max-w-2xl px-4 py-24 text-center">
        ...
        <div className="mx-auto mt-8 max-w-md rounded-xl border border-border bg-card p-6 text-left shadow-soft">
        ...
        <Link
          to="/"
          className="mt-8 inline-flex items-center justify-center rounded-md border border-input bg-card px-5 py-2.5 text-sm font-medium hover:bg-muted"
        >
          Back to home
        </Link>
      </div>
